...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <button class="btn btn-primary userEdit" data-bs-toggle="modal" data-bs-target="#createStudentModal"
                type="button">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="last-name" type="text"
                                ...
                                value="{{ old('last_name', $student->last_name) }}" name="last_name">
                            @error('last_name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="first-name" type="text"
                                ...
                                value="{{ old('first_name', $student->first_name) }}" placeholder="">
                            @error('first_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="marital_status" id="marital_status" class="form-control">
                                ...
                                <option value="married" @if($student->gender == 'married') selected @endif>Female
                                </option>
                                <option value="divorced" @if($student->gender == 'divorced') selected @endif>Divorced
                                </option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="mat_no" type="text" class="form-control @error('mat_no') is-invalid @enderror"
                                name="mat_no" value="{{ old('mat_no', $student->mat_no) }}">
                            @error('mat_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="department" type="text" class="form-control @error('dept') is-invalid @enderror"
                                name="dept" value="{{ old('dept', $student->dept) }}">
                            @error('dept')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="cgpa" type="text" class="form-control @error('cgpa') is-invalid @enderror"
                                name="cgpa" value="{{ old('cgpa', $student->cgpa) }}">
                            @error('cgpa')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="admission_year" type="text"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="$('#students-form').submit()"
                    id="register-btn">Update</button>
            </div>
        </div>
    </div>
</div>
